    ...
    private void login(HttpServletRequest request, HttpServletResponse response) {
        ...
        if (account != null) {
            try {
                ...
                request.getSession().setAttribute("passwordSession", account.getPassword());
                request.getSession().setAttribute("accountUsernameSession", account.getUsername());
                request.getSession().setAttribute("idSession", account.getId());
