...
<div class="container-fluid mx-auto">
    <div class="row justify-content-between py-1">
        <div class="col-4">
            <a class="btn btn-primary" href="/user?action=create" role="button"> + Edit contract</a>
        </div>
        <div class="col-2">
    ...
    <table id="myTable2" class="table table-striped table-bordered table-dark table-hover" style="width: 95%;margin:auto">
...
<%--            <th scope="col">Delete</th>--%>
        ...
        <tbody>
        <c:forEach var="contract" items="${userList}" varStatus="index">
            <tr>
                <td>${index.count}</td>
