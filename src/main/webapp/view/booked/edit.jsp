...
<div class="container-fluid row ">
    <div class="col-5 mx-auto">
        <h2 class="text-center py-1"> Confirm Booking </h2>
        <div class="container mx-auto shadow-lg p-3 mb-5 bg-white rounded-lg">
            <form method="post"  >
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
<%--                            <option value="waiting" ${booking.status eq "waiting" ? 'selected' : ''}>waiting</option>--%>
...
<%--                           href="/bookeds?action=change&id=${booking.id}">--%>
<%--                            Confirm--%>
<%--                        </a>--%>
