...
public class HouseServiceImpl implements IHouseService {
    private IHouseRepository iHouseRepository = new HouseRepositoryImpl();
...
//    }
    ...
    public List<House> search(String fieldSearch1, String fieldSearch2, String fieldSearch3, String searchKey1, String searchKey2, String searchKey3) {
        return iHouseRepository.search(fieldSearch1, fieldSearch2, fieldSearch3, searchKey1, searchKey2, searchKey3);
    }

    @Override
    public List<House> findByName(String name) {
        return iHouseRepository.findByName(name);
    }
    ...
    public boolean update(House house) throws SQLException {
        return iHouseRepository.update(house);
    }

    @Override
    public boolean delete(int id) throws SQLException {
        return iHouseRepository.delete(id);
    }
    ...
    @Override
    public Map<String, String> save1(House house) {
        return null;
    }

    @Override
    public Map<String, String> update1(House house) {
        return null;
    }
    ...
    public boolean remove(Integer id) {
        ...
        return iHouseRepository.remove(id);
    }
}
