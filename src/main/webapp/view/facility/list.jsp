    ...
    <table id="myTable2" class="table table-striped table-bordered table-dark table-hover" style="width: 100%">
        ...
        <c:forEach var="facility" items="${facilityList}" varStatus="index">
            <tr>
                <td>${index.count}</td>
                <td>
                    <a href="/facilitys?action=view&id=${facility.id}">
                            ${facility.name}
                    </a>
                </td>
                ...
                <td>
                    <a class="btn btn-warning" role="button" href="/facilitys?action=edit&id=${facility.id}">
                        edit
                    </a>
                </td>
                <td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <div class="mx-auto row">
                    <form action="/facilitys" method="post">
