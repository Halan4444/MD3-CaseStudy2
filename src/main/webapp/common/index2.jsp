...
<head>
  ...
  <title>CaseStudy Travel Product </title>
...
<section class="home" id="home">
  ...
  <div class="content">
    ...
    <a data-aos="fade-up" data-aos-delay="600" class="btn" href="ProductServlet" >Book Now</a>
...
<section class="destination" id="destination">
  ...
  <div class="box-container">
    ...
    <form method="post" action="/fileuploadservlet" enctype="multipart/form-data" style="background-color: #29d9d5">
