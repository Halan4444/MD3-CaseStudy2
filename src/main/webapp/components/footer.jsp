...
<footer class="text-center text-md-start bg-dark text-muted">
    <section class="footer">
        <div class="box-container">
            <div class="box" data-aos="fade-up" data-aos-delay="150">
                <a href="#" class="logo"> <i class="fas fa-paper-plane"></i>CGym </a>
            ...
            <div class="box" data-aos="fade-up" data-aos-delay="450">
                <h3>contact info</h3>
                <p> <i class="fas fa-map"></i> Hanoi, VietNam</p>
                <p> <i class="fas fa-phone"></i> +84915924251 </p>
                <p> <i class="fas fa-envelope"></i> Halan4444b@gmail.com </p>
    ...
    <div class="credit">created by <span>mr.Halan</span> | all rights reserved!</div>
</footer>