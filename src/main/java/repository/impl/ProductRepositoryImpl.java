...
public class ProductRepositoryImpl implements IContractRepository {
    private BaseRepository baseRepository = new BaseRepository();
    private static final String SELECT_ALL_PRODUCT_DTO = "SELECT ct.contract_id,\n" +
            "       ct.date_signed,\n" +
            "       ct.date_end,\n" +
            "       ct.deposit,\n" +
            "       e.name,\n" +
    ...
    public List<ContractDTO> getList() {
        ...
        try {
            preparedStatement = this.baseRepository.getConnection().prepareStatement(SELECT_ALL_PRODUCT_DTO);
